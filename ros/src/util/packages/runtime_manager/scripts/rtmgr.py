...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_aev_interface_qs = wx.ToggleButton(self.tab_qs, wx.ID_ANY, _("AEV Interface"))
		...
		self.button_aev_interface_interface = wx.ToggleButton(self.tab_interface, wx.ID_ANY, _("AEV Interface"))
