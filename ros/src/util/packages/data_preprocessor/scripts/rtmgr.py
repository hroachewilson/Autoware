...
class MyFrame(wx.Frame):
	...
	def __do_layout(self):
		...
		# sizer_59.Add(self.button_aev_interface_qs, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
		...
		# sizer_25.Add(self.button_aev_interface_interface, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
